...
VoiceHub предоставляет интеграции моделей синтеза речи через унифицированные
API конфигурации, процессора, модели, результата генерации и тренера. Реализации
...
Реестр содержит **31 интеграцию для инференса**. Для **18 из них описан способ
дообучения**, включая **6 интеграций, принимающих обычные необработанные
записи**. Возможность дообучения зависит от конкретных checkpoint и среды
...
[каталог моделей](models/index.md) и
[матрицу обучения с учетом checkpoint](models/training-support.md).
