...
Реестр содержит **34 интеграции TTS**, **14 провайдеров ASR** и **11 провайдеров
...
-   **Модели**
    ...
    Сравнивайте записи TTS в реестре: checkpoint по умолчанию, возможности,
    происхождение исходного кода и ограничения.
