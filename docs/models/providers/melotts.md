---
description: Inference, data preparation, and training guide for the melotts integration.
---
...
The `melotts` contract is **preprocessed**. Its
...
contract = get_tts_dataset_spec('melotts')
...
trainer.save_model("runs/melotts-smoke/final")
```
