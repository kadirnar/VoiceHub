---
description: Inference, data preparation, and training guide for the asr_medasr integration.
---
...
The `asr_medasr` contract is **integrated-raw**. Its
...
contract = get_asr_dataset_spec('asr_medasr')
...
arguments = TrainingArguments(
    output_dir="runs/asr_medasr-smoke",
    max_steps=1,
...
trainer.save_model("runs/asr_medasr-smoke/final")
```
