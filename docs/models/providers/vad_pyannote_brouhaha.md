---
description: Inference, data preparation, and training guide for the vad_pyannote_brouhaha integration.
---
...
arguments = TrainingArguments(
    output_dir="runs/vad_pyannote_brouhaha-smoke",
    max_steps=1,
...
trainer.save_model("runs/vad_pyannote_brouhaha-smoke/final")
```
