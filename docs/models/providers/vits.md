---
description: Inference, data preparation, and training guide for the vits integration.
---
...
The `vits` contract is **integrated-raw**. Its
...
contract = get_tts_dataset_spec('vits')
...
trainer.save_model("runs/vits-smoke/final")
```
