---
description: Inference, data preparation, and training guide for the speecht5 integration.
---
...
The `speecht5` contract is **integrated-raw**. Its
...
contract = get_tts_dataset_spec('speecht5')
...
arguments = TrainingArguments(
    output_dir="runs/speecht5-smoke",
    max_steps=1,
...
trainer.save_model("runs/speecht5-smoke/final")
```
