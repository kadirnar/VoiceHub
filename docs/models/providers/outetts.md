---
description: Inference, data preparation, and training guide for the outetts integration.
---
...
data and training contracts, so the documented support stays aligned with code. [Open the `outetts` Colab notebook](https://colab.research.google.com/github/kadirnar/voicehub/blob/main/notebooks/models/outetts.ipynb).
...
The `outetts` contract is **preprocessed**. Its
...
contract = get_tts_dataset_spec('outetts')
...
trainer.save_model("runs/outetts-smoke/final")
```
