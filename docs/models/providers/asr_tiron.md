---
description: Inference, data preparation, and training guide for the asr_tiron integration.
---
...
The `asr_tiron` contract is **integrated-raw**. Its
...
contract = get_asr_dataset_spec('asr_tiron')
...
arguments = TrainingArguments(
    output_dir="runs/asr_tiron-smoke",
    max_steps=1,
...
trainer.save_model("runs/asr_tiron-smoke/final")
```
