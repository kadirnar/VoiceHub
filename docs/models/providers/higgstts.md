---
description: Inference, data preparation, and training guide for the higgstts integration.
---

# `higgstts` model guide

`higgstts` is a VoiceHub **text to speech**
integration. This page is generated from the model registry and its executable
data and training contracts, so the documented support stays aligned with code. [Open the `higgstts` Colab notebook](https://colab.research.google.com/github/kadirnar/voicehub/blob/main/notebooks/models/higgstts.ipynb).
...
The `higgstts` contract is **integrated-raw**. Its
...
contract = get_tts_dataset_spec('higgstts')
...
arguments = TrainingArguments(
    output_dir="runs/higgstts-smoke",
    max_steps=1,
...
trainer.save_model("runs/higgstts-smoke/final")
```
