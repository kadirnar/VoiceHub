---
description: Inference, data preparation, and training guide for the fishtts integration.
---
...
The `fishtts` contract is **preprocessed**. Its
...
contract = get_tts_dataset_spec('fishtts')
...
trainer.save_model("runs/fishtts-smoke/final")
```
