---
description: Inference, data preparation, and training guide for the csm integration.
---
...
The `csm` contract is **integrated-raw**. Its
...
contract = get_tts_dataset_spec('csm')
...
trainer.save_model("runs/csm-smoke/final")
```
