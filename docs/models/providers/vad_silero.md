---
description: Inference, data preparation, and training guide for the vad_silero integration.
---
...
segment-level speech labels. Training phases consume `input_values`, `labels`.
...
arguments = TrainingArguments(
    output_dir="runs/vad_silero-smoke",
    max_steps=1,
...
trainer.save_model("runs/vad_silero-smoke/final")
```
