---
description: Inference, data preparation, and training guide for the dia integration.
---
...
The `dia` contract is **integrated-raw**. Its
...
trainer.save_model("runs/dia-smoke/final")
```
