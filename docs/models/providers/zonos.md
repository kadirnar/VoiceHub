---
description: Inference, data preparation, and training guide for the zonos integration.
---
...
The `zonos` contract is **preprocessed**. Its
...
contract = get_tts_dataset_spec('zonos')
...
trainer.save_model("runs/zonos-smoke/final")
```
