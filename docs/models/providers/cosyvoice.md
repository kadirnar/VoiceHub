---
description: Inference, data preparation, and training guide for the cosyvoice integration.
---
...
The `cosyvoice` contract is **integrated-raw**. Its
...
arguments = TrainingArguments(
    output_dir="runs/cosyvoice-smoke",
    max_steps=1,
...
trainer.save_model("runs/cosyvoice-smoke/final")
```
