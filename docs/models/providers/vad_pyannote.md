---
description: Inference, data preparation, and training guide for the vad_pyannote integration.
---
...
arguments = TrainingArguments(
    output_dir="runs/vad_pyannote-smoke",
    max_steps=1,
...
trainer.save_model("runs/vad_pyannote-smoke/final")
```
