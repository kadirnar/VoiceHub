---
description: Inference, data preparation, and training guide for the asr_moonshine integration.
---
...
The `asr_moonshine` contract is **integrated-raw**. Its
...
contract = get_asr_dataset_spec('asr_moonshine')
...
arguments = TrainingArguments(
    output_dir="runs/asr_moonshine-smoke",
    max_steps=1,
...
trainer.save_model("runs/asr_moonshine-smoke/final")
```
