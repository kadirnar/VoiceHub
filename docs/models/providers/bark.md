---
description: Inference, data preparation, and training guide for the bark integration.
---
...
The `bark` contract is **preprocessed**. Its
...
contract = get_tts_dataset_spec('bark')
...
trainer.save_model("runs/bark-smoke/final")
```
