---
description: Inference, data preparation, and training guide for the asr_cohere integration.
---
...
The `asr_cohere` contract is **integrated-raw**. Its
...
contract = get_asr_dataset_spec('asr_cohere')
...
arguments = TrainingArguments(
    output_dir="runs/asr_cohere-smoke",
    max_steps=1,
...
trainer.save_model("runs/asr_cohere-smoke/final")
```
