---
description: Inference, data preparation, and training guide for the f5tts integration.
---
...
The `f5tts` contract is **preprocessed**. Its
...
trainer.save_model("runs/f5tts-smoke/final")
```
