---
description: Inference, data preparation, and training guide for the omnivoice integration.
---
...
The `omnivoice` contract is **integrated-raw**. Its
...
contract = get_tts_dataset_spec('omnivoice')
...
arguments = TrainingArguments(
    output_dir="runs/omnivoice-smoke",
    max_steps=1,
...
trainer.save_model("runs/omnivoice-smoke/final")
```
