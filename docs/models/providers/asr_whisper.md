---
description: Inference, data preparation, and training guide for the asr_whisper integration.
---
...
The `asr_whisper` contract is **integrated-raw**. Its
...
arguments = TrainingArguments(
    output_dir="runs/asr_whisper-smoke",
    max_steps=1,
...
trainer.save_model("runs/asr_whisper-smoke/final")
```
