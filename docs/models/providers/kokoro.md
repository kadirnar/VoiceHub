---
description: Inference, data preparation, and training guide for the kokoro integration.
---
...
The `kokoro` contract is **preprocessed**. Its
data architecture is **acoustic** and its declared sample rate is
**24,000 Hz**.

Direct acoustic, mel, codec, or waveform regression data.
...
contract = get_tts_dataset_spec('kokoro')
...
trainer.save_model("runs/kokoro-smoke/final")
```
