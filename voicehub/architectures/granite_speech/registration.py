...
def create_granite_speech_architecture_spec() -> ArchitectureSpec:
    ...
    return ArchitectureSpec(
        ...
        config=("voicehub.architectures.granite_speech.configuration:"
                "GraniteSpeechArchitectureConfig"),
        processor=("voicehub.architectures.granite_speech.processing:"
        ...
        components={
            "audio-encoder": ("voicehub.architectures.granite_speech.modeling:"
                              "GraniteSpeechCTCEncoder"),
            "audio-projector":
            ("voicehub.architectures.granite_speech.modeling:"
             "GraniteSpeechEncoderProjector"),
            "language-model": ("voicehub.architectures.causal_lm.modeling:"
                               "GraniteForCausalLM"),
            "runtime": ("voicehub.architectures.granite_speech.runtime:"
                        "GraniteSpeechRuntime"),
            "tokenizer": ("voicehub.architectures.granite_speech.tokenization:"
