...
def create_encodec_architecture_spec() -> ArchitectureSpec:
    ...
    return ArchitectureSpec(
        ...
        config=(
            "voicehub.components.audio.codecs.encodec.configuration:"
            "EncodecConfig"
        ),
        checkpoint_adapter=(
        ...
        decoder=(
            "voicehub.components.audio.codecs.encodec.layers:"
            "SEANetDecoder"
        ),
        components={
            "artifact-resolver": (
            ...
            "quantizer": (
                "voicehub.components.audio.codecs.encodec.quantization:"
        ...
        metadata={
            ...
            "source": ENCODEC_SOURCE_REPOSITORY,
            "native_checkpoint_format": "voicehub-encodec-v1",
