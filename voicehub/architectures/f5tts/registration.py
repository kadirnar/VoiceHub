...
def create_f5tts_architecture_spec() -> ArchitectureSpec:
    return ArchitectureSpec(
        ...
        version="1",
        model_builder=(
            "voicehub.architectures.f5tts.modeling:build_f5tts_model"
        ),
        config=(
            "voicehub.architectures.f5tts.configuration:"
            "F5TTSArchitectureConfig"
        ),
        processor=(
            "voicehub.architectures.f5tts.frontend:NativeF5TextFrontend"
        ),
        ...
        components={
            ...
            "artifact-resolver": (
                "voicehub.architectures.f5tts.artifacts:"
        ...
        metadata={
            ...
            "source": (
                "https://github.com/SWivid/F5-TTS/tree/"
                f"{F5TTS_SOURCE_REVISION}"
            ),
            "reference_checkpoint": F5TTS_CHECKPOINT_REPOSITORY,
            "reference_checkpoint_revision": F5TTS_CHECKPOINT_REVISION,
            "checkpoint_license": F5TTS_CHECKPOINT_LICENSE,
            "vocoder": VOCOS_REPOSITORY,
            "vocoder_checkpoint_revision": VOCOS_CHECKPOINT_REVISION,
            "vocoder_source_revision": VOCOS_SOURCE_REVISION,
            "training_boundary": (
