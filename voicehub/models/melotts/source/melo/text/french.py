...
def get_bert_feature(text, word2ph, device=None):
    from voicehub.models.melotts.source.melo.text import french_bert
...
if __name__ == "__main__":
    ...
    from voicehub.models.melotts.source.melo.text.fr_phonemizer.gruut_wrapper import Gruut
    from voicehub.models.melotts.source.melo.text.cleaner_multiling import unicleaners
    ...
    text = text_normalize(ori_text)
    print(text)
    phonemizer = Gruut("fr-fr", keep_puncs=True, keep_stress=True, use_espeak_phonemes=True)
    # phonemizer.lang_to_phonemizer['fr'].keep_stress = True
    # phonemizer.lang_to_phonemizer['fr'].use_espeak_phonemes = True
    phoneme = phonemizer.phonemize(text, separator="")
    print(phoneme)