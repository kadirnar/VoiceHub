...
from voicehub.models.zonos2.source.zonos2.utils.moe_topk import normalize_special_topk_layers
...
def _load_zonos2_config(model_path: str) -> Zonos2Config:
    ...
    def _apply_data_sidecar(model_params: dict, data_cfg) -> None:
        ...
        if rate_count > 0 and model_params.get("text_vocab") is None:
            try:
                from voicehub.models.zonos2.source.zonos2.tts.prompt import conditioned_text_vocab_size
