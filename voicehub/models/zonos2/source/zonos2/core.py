...
if TYPE_CHECKING:
    from voicehub.models.zonos2.source.zonos2.attention import BaseAttnBackend, BaseAttnMetadata
    from voicehub.models.zonos2.source.zonos2.kvcache import BaseCacheHandle
