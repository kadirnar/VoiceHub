...
import torch
from voicehub.models.zonos2.source.zonos2.distributed import DistributedInfo
...
from voicehub.models.zonos2.source.zonos2.message.tts import TTSSamplingParams
from voicehub.models.zonos2.source.zonos2.scheduler import SchedulerConfig
from voicehub.models.zonos2.source.zonos2.scheduler.scheduler import TTSScheduler
from voicehub.models.zonos2.source.zonos2.tokenizer.vocoder import TTSVocoderManager, shear_up
...
class TTSLLM(TTSScheduler):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from voicehub.models.zonos2.source.zonos2.tokenizer.textnorm import TTSTextNormalizer, normalization_enabled
    ...
    def embed_speaker_file(self, path: str) -> torch.Tensor:
        ...
        with open(path, "rb") as f:
            audio_bytes = f.read()
        try:
            from voicehub.models.zonos2.source.zonos2.tts.audio import _decode_audio_bytes
    ...
    def resolve_speaking_rate_bucket(
        ...
        *,
        ...
        """
        from voicehub.models.zonos2.source.zonos2.tts.conditioning import _resolve_speaking_rate_bucket
    ...
    def resolve_quality_buckets(
        ...
        *,
        ...
        """
        from voicehub.models.zonos2.source.zonos2.tts.conditioning import _resolve_quality_buckets
    ...
    def resolve_max_tokens(self, requested: int | None) -> int:
        ...
        from voicehub.models.zonos2.source.zonos2.tts.conditioning import _resolve_tts_max_tokens
