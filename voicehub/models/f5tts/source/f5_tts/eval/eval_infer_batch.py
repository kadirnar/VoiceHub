...
from voicehub.models.f5tts.source.f5_tts.eval.utils_eval import (
    get_inference_prompt,
    get_librispeech_test_clean_metainfo,
    get_seedtts_testset_metainfo,
)
from voicehub.models.f5tts.source.f5_tts.infer.utils_infer import load_checkpoint, load_vocoder
...
rel_path = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("../../"))
