...
from voicehub.models.f5tts.source.f5_tts.model.dataset import DynamicBatchSampler, collate_fn
from voicehub.models.f5tts.source.f5_tts.model.utils import default, exists
...
class Trainer:
    ...
    def train(self, train_dataset: Dataset, num_workers=16, resumable_with_seed: int = None):
        if self.log_samples:
            from voicehub.models.f5tts.source.f5_tts.infer.utils_infer import cfg_strength, load_vocoder, nfe_step, sway_sampling_coef
