...
from voicehub.models.f5tts.source.f5_tts.model.modules import MelSpec
from voicehub.models.f5tts.source.f5_tts.model.utils import default
...
def load_dataset(
    ...
    if dataset_type == "CustomDataset":
        rel_data_path = str(files("voicehub.models.f5tts.source.f5_tts").joinpath(f"../../data/{dataset_name}_{tokenizer}"))
        if audio_type == "raw":
            try:
        ...
        train_dataset = HFDataset(
            load_dataset(f"{pre}/{pre}", split=f"train.{post}", cache_dir=str(files("voicehub.models.f5tts.source.f5_tts").joinpath("../../data"))),
        )
