...
def load_vocoder(vocoder_name="vocos", is_local=False, local_path="", device=device, hf_cache_dir=None):
    if vocoder_name == "vocos":
        ...
        try:
            from voicehub.models.f5tts.source.third_party.BigVGAN import bigvgan
        except ImportError:
...
def load_model(
    ...
    if vocab_file == "":
        vocab_file = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("infer/examples/vocab.txt"))
    tokenizer = "custom"
