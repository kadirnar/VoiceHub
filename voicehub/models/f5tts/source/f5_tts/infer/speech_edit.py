...
from voicehub.models.f5tts.source.f5_tts.infer.utils_infer import load_checkpoint, load_vocoder, save_spectrogram
...
model_cfg = OmegaConf.load(str(files("voicehub.models.f5tts.source.f5_tts").joinpath(f"configs/{exp_name}.yaml")))
...
# ckpt_path = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("../../")) + f"/ckpts/{exp_name}/model_{ckpt_step}.safetensors"
...
audio_to_edit = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("infer/examples/basic/basic_ref_en.wav"))
