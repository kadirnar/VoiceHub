...
from voicehub.models.f5tts.source.f5_tts.model import CFM, DiT, Trainer, UNetT
...
def main():
    ...
    checkpoint_path = str(files("voicehub.models.f5tts.source.f5_tts").joinpath(f"../../ckpts/{args.dataset_name}"))
