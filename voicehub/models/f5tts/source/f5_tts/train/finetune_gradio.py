...
from voicehub.models.f5tts.source.f5_tts.api import F5TTS
from voicehub.models.f5tts.source.f5_tts.infer.utils_infer import transcribe
from voicehub.models.f5tts.source.f5_tts.model.utils import convert_char_to_pinyin
...
path_data = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("../../data"))
path_project_ckpts = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("../../ckpts"))
file_train = str(files("voicehub.models.f5tts.source.f5_tts").joinpath("train/finetune_cli.py"))
