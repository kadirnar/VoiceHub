...
from voicehub.models.chatterbox.source.s3tokenizer.model import Conv1d, LayerNorm, Linear
# Re-use V2 components where possible, but we might need specific V3 tweaks
from voicehub.models.chatterbox.source.s3tokenizer.model_v2 import (FSMNMultiHeadAttention,
                                  FSQVectorQuantization, precompute_freqs_cis)
from voicehub.models.chatterbox.source.s3tokenizer.utils import (make_non_pad_mask, mask_to_bias,
