...
from voicehub.models.xtts.source.TTS.tts.configs.glow_tts_config import GlowTTSConfig
from voicehub.models.xtts.source.TTS.tts.layers.glow_tts.decoder import Decoder
from voicehub.models.xtts.source.TTS.tts.layers.glow_tts.encoder import Encoder
...
class GlowTTS(BaseTTS):
    ...
    @staticmethod
    def get_criterion():
        from voicehub.models.xtts.source.TTS.tts.layers.losses import GlowTTSLoss  # pylint: disable=import-outside-toplevel
