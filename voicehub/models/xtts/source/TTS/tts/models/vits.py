...
from voicehub.models.xtts.source.TTS.tts.configs.shared_configs import CharactersConfig
from voicehub.models.xtts.source.TTS.tts.datasets.dataset import TTSDataset, _parse_sample
from voicehub.models.xtts.source.TTS.tts.layers.glow_tts.duration_predictor import DurationPredictor
from voicehub.models.xtts.source.TTS.tts.layers.vits.discriminator import VitsDiscriminator
from voicehub.models.xtts.source.TTS.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from voicehub.models.xtts.source.TTS.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from voicehub.models.xtts.source.TTS.tts.models.base_tts import BaseTTS
from voicehub.models.xtts.source.TTS.tts.utils.fairseq import rehash_fairseq_vits_checkpoint
from voicehub.models.xtts.source.TTS.tts.utils.helpers import generate_path, maximum_path, rand_segments, segment, sequence_mask
from voicehub.models.xtts.source.TTS.tts.utils.languages import LanguageManager
from voicehub.models.xtts.source.TTS.tts.utils.speakers import SpeakerManager
from voicehub.models.xtts.source.TTS.tts.utils.synthesis import synthesis
from voicehub.models.xtts.source.TTS.tts.utils.text.characters import BaseCharacters, BaseVocabulary, _characters, _pad, _phonemes, _punctuations
from voicehub.models.xtts.source.TTS.tts.utils.text.tokenizer import TTSTokenizer
from voicehub.models.xtts.source.TTS.tts.utils.visual import plot_alignment
from voicehub.models.xtts.source.TTS.utils.io import load_fsspec
from voicehub.models.xtts.source.TTS.utils.samplers import BucketBatchSampler
from voicehub.models.xtts.source.TTS.vocoder.models.hifigan_generator import HifiganGenerator
from voicehub.models.xtts.source.TTS.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from voicehub.models.xtts.source.TTS.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
    ...
    def load_fairseq_checkpoint(
        ...
        from voicehub.models.xtts.source.TTS.tts.utils.text.cleaners import basic_cleaners
    ...
    def init_from_config(config: "VitsConfig", samples: Union[List[List], List[Dict]] = None, verbose=True):
        ...
        Args:
            ...
            samples (Union[List[List], List[Dict]]): Training samples to parse speaker ids for training.
                Defaults to None.
        """
        from voicehub.models.xtts.source.TTS.utils.audio import AudioProcessor
