...
from voicehub.models.xtts.source.TTS.tts.layers.feed_forward.decoder import Decoder
from voicehub.models.xtts.source.TTS.tts.layers.feed_forward.encoder import Encoder
from voicehub.models.xtts.source.TTS.tts.layers.generic.aligner import AlignmentNetwork
from voicehub.models.xtts.source.TTS.tts.layers.generic.pos_encoding import PositionalEncoding
...
from voicehub.models.xtts.source.TTS.tts.utils.helpers import average_over_durations, generate_path, maximum_path, sequence_mask
...
from voicehub.models.xtts.source.TTS.tts.utils.visual import plot_alignment, plot_avg_energy, plot_avg_pitch, plot_spectrogram
...
class ForwardTTS(BaseTTS):
    ...
    def get_criterion(self):
        from voicehub.models.xtts.source.TTS.tts.layers.losses import ForwardTTSLoss  # pylint: disable=import-outside-toplevel
