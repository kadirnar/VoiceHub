...
from voicehub.models.xtts.source.TTS.tts.layers.align_tts.mdn import MDNBlock
from voicehub.models.xtts.source.TTS.tts.layers.feed_forward.decoder import Decoder
from voicehub.models.xtts.source.TTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from voicehub.models.xtts.source.TTS.tts.utils.helpers import generate_path, maximum_path, sequence_mask
...
from voicehub.models.xtts.source.TTS.tts.utils.visual import plot_alignment, plot_spectrogram
...
class AlignTTS(BaseTTS):
    ...
    def get_criterion(self):
        from voicehub.models.xtts.source.TTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
