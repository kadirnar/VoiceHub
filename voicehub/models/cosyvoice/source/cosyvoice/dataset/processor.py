...
from voicehub.models.cosyvoice.source.cosyvoice.utils.onnx import embedding_extractor, online_feature
...
def compute_whisper_fbank(data, num_frames=-1, mode='train'):
    ...
    for sample in data:
        ...
        sample['whisper_feat'] = log_mel_spectrogram(
            sample['speech_16k'],
            n_mels=128,
        ).squeeze(dim=0).transpose(0, 1)
        yield sample
