...
import uuid
from voicehub.models.cosyvoice.source.cosyvoice.utils.common import fade_in_out
from voicehub.models.cosyvoice.source.cosyvoice.utils.file_utils import convert_onnx_to_trt, export_cosyvoice2_vllm
from voicehub.models.cosyvoice.source.cosyvoice.utils.common import TrtContextWrapper
...
class CosyVoiceModel:
    ...
    def load_trt(self, flow_decoder_estimator_model, flow_decoder_onnx_model, trt_concurrent, fp16):
        assert self.device.type == 'cuda', 'tensorrt only supports gpu!'
