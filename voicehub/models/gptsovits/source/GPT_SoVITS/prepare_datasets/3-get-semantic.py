...
if version != "v3":
    from voicehub.models.gptsovits.source.GPT_SoVITS.module.models import SynthesizerTrn
else:
    from voicehub.models.gptsovits.source.GPT_SoVITS.module.models import SynthesizerTrnV3 as SynthesizerTrn
from voicehub.models.gptsovits.source.tools.my_utils import clean_path
