...
import torch
import torchaudio
from voicehub.models.gptsovits.source.GPT_SoVITS.text.LangSegmenter import LangSegmenter
...
import librosa
import numpy as np
from voicehub.models.gptsovits.source.GPT_SoVITS.feature_extractor import cnhubert
...
from voicehub.models.gptsovits.source.GPT_SoVITS.module.models import Generator, SynthesizerTrn, SynthesizerTrnV3
...
from voicehub.models.gptsovits.source.GPT_SoVITS.AR.models.t2s_lightning_module import Text2SemanticLightningModule
...
from voicehub.models.gptsovits.source.tools.assets import css, js, top_html
from voicehub.models.gptsovits.source.tools.i18n.i18n import I18nAuto, scan_language_list
...
from voicehub.models.gptsovits.source.GPT_SoVITS.process_ckpt import get_sovits_version_from_path_fast, load_sovits_new
...
def init_bigvgan():
    ...
    from voicehub.models.gptsovits.source.GPT_SoVITS.BigVGAN import bigvgan
...
from voicehub.models.gptsovits.source.GPT_SoVITS.sv import SV
...
from voicehub.models.gptsovits.source.GPT_SoVITS.text import chinese
...
from voicehub.models.gptsovits.source.GPT_SoVITS.module.mel_processing import mel_spectrogram_torch, spectrogram_torch
...
def audio_sr(audio, sr):
    global sr_model
    if sr_model == None:
        from voicehub.models.gptsovits.source.tools.audio_sr import AP_BWE
        ...
        if i_text in cache and if_freeze == True:
            ...
            if use_cuda_graph and device == "cuda":
                ...
                if t2s_model_cudagraph is None:
                    from voicehub.models.gptsovits.source.GPT_SoVITS.AR.models.t2s_model_cudagraph import CUDAGraphRunner
                ...
                from voicehub.models.gptsovits.source.GPT_SoVITS.AR.models.structs_cudagraph import T2SRequest
                with torch.no_grad():
